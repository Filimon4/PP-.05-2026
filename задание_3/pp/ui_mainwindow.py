...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.widget = QWidget(self.orders)
        self.widget.setObjectName(u"widget")
        self.widget.setGeometry(QRect(0, -3, 901, 541))
        ...
        self.order_list = QListView(self.widget)
        ...
        self.widget1 = QWidget(self.product_batches)
        self.widget1.setObjectName(u"widget1")
        self.widget1.setGeometry(QRect(0, 0, 891, 541))
        ...
        self.product_batches_change = QPushButton(self.widget1)
        ...
        self.product_batches_load = QPushButton(self.widget1)
        ...
        self.product_batches_list = QListView(self.widget1)
        ...
        self.widget2 = QWidget(self.customers)
        self.widget2.setObjectName(u"widget2")
        self.widget2.setGeometry(QRect(0, 0, 891, 541))
        ...
        self.customer_load = QPushButton(self.widget2)
        ...
        self.customer_list = QListView(self.widget2)
        ...
        self.layoutWidget = QWidget(self.materials)
        self.layoutWidget.setObjectName(u"layoutWidget")
        self.layoutWidget.setGeometry(QRect(0, 0, 891, 541))
        self.materials_layout = QVBoxLayout(self.layoutWidget)
        ...
        self.material_load = QPushButton(self.layoutWidget)
        ...
        self.material_list = QListView(self.layoutWidget)
        ...
        self.widget3 = QWidget(self.employee)
        self.widget3.setObjectName(u"widget3")
        self.widget3.setGeometry(QRect(0, 5, 891, 531))
        self.verticalLayout = QVBoxLayout(self.widget3)
        self.verticalLayout.setObjectName(u"verticalLayout")
        self.verticalLayout.setContentsMargins(0, 0, 0, 0)
        self.title = QLabel(self.widget3)
        ...
        self.employee_load = QPushButton(self.widget3)
        ...
        self.employee_list = QListView(self.widget3)
        ...
        self.widget4 = QWidget(self.products)
        self.widget4.setObjectName(u"widget4")
        self.widget4.setGeometry(QRect(0, 0, 881, 541))
        self.verticalLayout_4 = QVBoxLayout(self.widget4)
        ...
        self.product_load = QPushButton(self.widget4)
        ...
        self.product_list = QListView(self.widget4)
