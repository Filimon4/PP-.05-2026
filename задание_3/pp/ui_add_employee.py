...
class Ui_add_employee(object):
    def setupUi(self, add_employee):
        ...
        self.widget = QWidget(add_employee)
        self.widget.setObjectName(u"widget")
        self.widget.setGeometry(QRect(10, 10, 601, 451))
        ...
        self.first_name = QLineEdit(self.widget)
        ...
        self.family_name = QLineEdit(self.widget)
        ...
        self.last_name = QLineEdit(self.widget)
        ...
        self.position_combo = QComboBox(self.widget)
