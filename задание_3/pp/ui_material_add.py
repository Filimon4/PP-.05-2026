...
class Ui_material_add(object):
    def setupUi(self, material_add):
        ...
        material_add.setMinimumSize(QSize(420, 140))
        material_add.setMaximumSize(QSize(420, 140))
        material_add.setAutoFillBackground(False)
        self.widget = QWidget(material_add)
        self.widget.setObjectName(u"widget")
        self.widget.setGeometry(QRect(10, 10, 401, 112))
        ...
        self.materialName = QLineEdit(self.widget)
        ...
        self.materialUnits = QComboBox(self.widget)
    ...
    def retranslateUi(self, material_add):
        ...
        self.label.setText(QCoreApplication.translate("material_add", u"\u041d\u0430\u0437\u0432\u0430\u043d\u0435\u0438", None))
